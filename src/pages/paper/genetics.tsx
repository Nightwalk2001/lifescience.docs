...
const Genetics: NextPage = () => {
  return <div className={"flex flex-col items-center min-w-[900px] max-w-[80%] mx-auto prose"}>
    ...
    <img src={"/layer.png"} width={480} height={300} alt={""}/>
    <p className={"indent-[2em]"}>
    ...
    <img src={"/active-fn.png"} width={720} height={360} alt={""}/>
    <p className={"indent-[2em]"}>
    ...
    <img src={"/fn.png"} width={600} height={420} alt={""}/>
    <p className={"indent-[2em]"}>
    ...
    <img src={"/cnn.png"} width={600} height={240} alt={""}/>
    <p className={"indent-[2em]"}>
    ...
    <img src={"/conv.png"} width={480} height={300} alt={""}/>
    <p className={"indent-[2em]"}>
    ...
    <img src={"/pooling.png"} width={480} height={360} alt={""}/>
    <p className={"indent-[2em]"}>
      在浅层卷积里面，我们可以看到一些边缘，随着卷积层加深，我们可以看到眼睛、耳朵等特征，层数再加深就可以看到完整的面部等特征了。
    </p>
    <img src={"/many-layer.jpg"} width={480} height={250} alt={""}/>
    <p className={"indent-[2em]"}>
