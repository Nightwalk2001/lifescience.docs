...
export const Anim: React.FC = () => <Layout
  ...
  right={
    <div className={"prose-sm px-3.5 py-3 text-xl bg-white rounded-lg shadow-xl"}>
      ...
      掌握JavaScript/TypeScript、Kotlin、Swift、Java、Python、Golang、Rust、Dart、Scala、Clojure、F#、C#等图灵完备语言。<br/>
      ...
      熟悉各类运维技术，包括Linux、K8s、Istio、Elastic Stack、Docker、CI/CD工具如Github Workflow、Travis CI等。<br/>
      擅长数据可视化，熟练使用D3.js，可以手写path。<br/>
      能使用深度学习、强化学习解决各类问题。<br/>
      熟练使用Canvas API、OpenGL API及Three.js。
    </div>
  }/>
