import {NavPopover} from "@/widgets"
...
export const Navigation: React.FC = () => <div
  className={"relative px-8 pt-6 lg:pt-8 flex items-center justify-between text-gray-700 font-semibold text-sm leading-6 dark:text-gray-200"}>
